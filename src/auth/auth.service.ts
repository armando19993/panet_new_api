...
export class AuthService {
  ...
  async login(data) {
    ...
    this.notificationService.sendPushNotification(data.pushToken.data ? data.pushToken.data : val.expoPushToken, 'Has Iniciado Sesion', 'Has iniciado sesion en un nuevo dispositivo, hemos actualizado tu codigo de notificacion')
